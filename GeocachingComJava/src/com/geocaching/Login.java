...
public abstract class Login {
    ...
    private static StatusCode login(String username, String password, boolean retry) {
        // TODO:
        final ImmutablePair<String, String> login = new ImmutablePair<String, String>(username, password);
