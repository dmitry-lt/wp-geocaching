...
namespace GeocachingPlus.View.Converters
{
    public class GeocachingComIconConverter : IValueConverter
    {
        ...
        {
            var type = GeocachingComCache.Types.UNKNOWN;

            if (value is GeocachingComCache.Types)
            {
                type = (GeocachingComCache.Types)value;
            }
            else if (value is GeocachingComCache)
            {
                type = (value as GeocachingComCache).Type;
            }
